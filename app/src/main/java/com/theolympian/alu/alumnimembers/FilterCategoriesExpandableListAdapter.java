...
import com.theolympian.alu.commonutils.CheckBoxImageView;
...
public class FilterCategoriesExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public FilterCategoriesExpandableListAdapter(Activity activity, ArrayList<HashMap<String, String>> parentItems,
    ...
    public View getGroupView(final int groupPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            if(isFromMyCategoriesFragment) {
                convertView = inflater.inflate(R.layout.group_list_my_categories, null);
            }else {
                convertView = inflater.inflate(R.layout.group_list_choose_categories, null);
            }
        ...
        viewHolderParent.cbMainCategory.setOnCheckedChangeListener(new CheckBoxImageView.OnCheckedChangeListener() {
            @Override
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.child_list_choose_category, null);
        ...
        viewHolderChild.cbSubCategory.setOnCheckedChangeListener(new CheckBoxImageView.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(View buttonView, boolean isChecked) {
                if (isChecked) {
                    count = 0;
    ...
    private class ViewHolderParent {
        ...
        CheckBoxImageView cbMainCategory;
    ...
    private class ViewHolderChild {
        ...
        CheckBoxImageView cbSubCategory;
        View viewDivider;
    }
